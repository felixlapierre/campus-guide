...
object FloorPlans {
    ...
    fun setUpChangeFloor(map: GoogleMapAdapter, buildingIndexSingleton: BuildingIndexSingleton, directionsFlow: DirectionsFlow) {
        changeFloor = ChangeFloor(map, buildingIndexSingleton, directionsFlow)
    }
